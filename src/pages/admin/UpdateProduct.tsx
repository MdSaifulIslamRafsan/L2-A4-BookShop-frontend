...
import { useGetProductQuery, useUpdateProductMutation } from "../../redux/features/Products/ProductsApi";
            ...
            >
                ...
                {imageUrl && (
                    <div style={{ marginBottom: "20px" }}>
                        <img src={imageUrl} alt="Uploaded" style={{ width: "100%", maxHeight: "200px", objectFit: "cover" }} />
                        <p>{imageName}</p>
                    </div>
                )}
                    ...
                    <Row gutter={[16, 16]}>
                        ...
                        <Col xs={24} sm={24} md={12}>
                            ...
                            <BSInput
                                ...
                                type="text"
                                fieldName="author"
                                defaultValue={product.data.author || ""}
                            />
                            <BSInput
                                label="Price"
                                type="number"
                                fieldName="price"
                                defaultValue={product.data.price || 0}
                            />
                        </Col>
                        ...
                        <Col xs={24} sm={24} md={12}>
                            <BSInput
                                ...
                                type="number"
                                fieldName="quantity"
                                defaultValue={product.data.quantity || 0}
                            />
                            <BSInput
                                label="In Stock"
                                type="text"
                                fieldName="inStock"
                                defaultValue={product.data.inStock ? "Yes" : "No"}
                            />
